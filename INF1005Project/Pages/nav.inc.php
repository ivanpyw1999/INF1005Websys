    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <div>
            <form action="searchbar.php" method="post" class="d-flex">
                <input type="text" id="searchbar" name="searchbar" class="form-control" style="border-top-right-radius: 0px;border-bottom-right-radius: 0px" placeholder="Search our products list!">
