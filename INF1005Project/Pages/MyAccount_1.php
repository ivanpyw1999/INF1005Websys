...
if (isset($_REQUEST["personal-information-edit-button"])) {
    ...
    if (empty($_POST["email"])) {
        ...
        header("Location: ../Pages/MyAccount_1.php?errorMsgPersonal=" . $errorMsg);
    }
    ...
    if ($success) {
        ...
        header("Location: ../Pages/MyAccount_1.php?errorMsgPersonal=" . $errorMsg); //temp - remove
        //        header("Location: ../Pages/MyAccount_1.php");
    }
}
...
if (isset($_REQUEST["delivery-location-edit-button"])) {
    ...
    if (empty($_POST["street"])) {
        ...
        $success = false;
        header("Location: ../Pages/MyAccount_1.php?errorMsgDelivery=" . $errorMsg);
    }
    if (empty($_POST["blk"])) {
    ...
    if ($success) {
        ...
        // reload page to display new information
        header("Location: ../Pages/MyAccount_1.php?errorMsgDelivery=" . $errorMsg); //temp - remove 
//        header("Location: ../Pages/MyAccount_1.php");
    }
}
...
if (isset($_REQUEST["change-password-check-button"])) {
    ...
    if ($success) {
        ...
        header("Location: ../Pages/MyAccount_1.php?errorMsgPassword=Successfully Changed Password !");
        // if not correct
//        header("Location: ../Pages/MyAccount_1.php?errorMsgPassword=" . $errorMsg); //remove errorMSg 
    }
}
